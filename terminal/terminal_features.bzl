...
TERMINAL_SERVER_DEPS = REMOTE_FN_STREAMING_DEPS + REMOTE_FN_UNARY_DEPS + SERVER_DEPS + TERMINAL_DEPS + TILES_STATE_SERVER_DEPS + [
    "//pty",
    "@crates//:dashmap",
    "@crates//:pin-project",
    "@crates//:tracing-futures",
...
_EXCLUSION_MAP = [
    ...
    {"feature": "remote-fn", "delta": [89, 108, 6, 511]},
    {"feature": "remote-fn-unary", "delta": [-509, -106, 10]},
    ...
    {"feature": "terminal", "delta": [-266, 4, -256, 3, -86, 7, 268, 2, 274, 4, 284, 4, 294, 21, 513]},
    {"feature": "text-editor", "delta": [-511, -334, 21, -290, 4, -280, 4, -270, 2, 52, 11, 128, 3, 224, 3, 338, 17, 374, 16, 410, 24]},
    {"feature": "client", "delta": [-444, 4, -426, 2, -418, 3, -409, -404, 16, -369, -366, 5, -354, 9, -132, 3, -72, 11, 3, 6, 2, 204, 3, 212, 6, 233, 237, 286, 3, 316, 3, 326, 5, 495, 507, 513]},
    {"feature": "server", "delta": [-511, -505, -493, -456, 6, -436, 5, -422, 2, -411, -367, -355, -334, 5, -320, 3, -290, 3, -235, -231, -228, 9, -208, 3, -8, 2, -1, 16, 3, 34, 61, 158, 5, 176, 13, 255, 268, 2, 274, 4, 294, 11, 325, 347, 355, 358, 5, 415, 419, 509]},
]

...
declare_icon!(paragraph, "/icons/paragraph.svg"; feature = "terminal-client");
declare_icon!(mic_fill, "/icons/mic-fill.svg"; feature = "terminal-client");
declare_icon!(mic_mute_fill, "/icons/mic-mute-fill.svg"; feature = "terminal-client");
declare_icon!(send_fill, "/icons/send-fill.svg"; feature = "terminal-client");

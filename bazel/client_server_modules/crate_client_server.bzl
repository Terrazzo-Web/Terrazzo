...
def _crate_client_server_module_impl(ctx):
    ...
    tokio_features = _format_string_list(ctx.attr.tokio_features)

    content = """# This file is automatically generated.
{name} = use_extension("@rules_rust//crate_universe:extensions.bzl", "crate")
{name}.annotation(
    crate = "server_fn",
...
_crate_client_server_module = rule(
    ...
    attrs = {
        ...
        "tokio_features": attr.string_list(),
    },
)

def crate_client_server_module(
        name,
        server_fn_features,
        server_fn_deps = [],
        tracing_features = [],

...
pub fn install_assets() {
    ...
    declare_asset!("/assets/css/terrazzo.css").install();
    install_icons();
    install_xterm();
    install_wasm();
}
...
fn install_wasm() {
    declare_asset!("/assets/wasm/terrazzo.js")
        .asset_name("wasm/terrazzo.js")
        .install();
    declare_asset!("/assets/wasm/terrazzo_bg.wasm")
        .asset_name("wasm/terrazzo_bg.wasm")
        .install();

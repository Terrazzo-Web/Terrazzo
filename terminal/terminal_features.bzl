...
TERMINAL_CLIENT_DEPS = CLIENT_DEPS + TERMINAL_DEPS + TILES_STATE_CLIENT_DEPS + [
    "@crates//:futures",
    "@crates//:scopeguard",
    "@crates//:web-sys",
]
...
TERMINAL_SERVER_DEPS = REMOTE_FN_UNARY_DEPS + SERVER_DEPS + TERMINAL_DEPS + TILES_STATE_SERVER_DEPS + [
    "//pty",
    "@crates//:dashmap",
    "@crates//:pin-project",
    "@crates//:tracing-futures",
...
_EXCLUSION_MAP = [
    ...
    {"feature": "logs-panel", "delta": [-202, 15, -170, 2, 232, 4, 242, 5, 470, 2]},
    {"feature": "port-forward", "delta": [-472, 2, -250, 5, -238, 4, 74, 7, 252, 3, 260, 4]},
    {"feature": "terminal", "delta": [-266, 4, -256, 3, -86, 7, 128, 3, 268, 2, 274, 4, 284, 4, 294, 6]},
    {"feature": "server", "delta": [-304, 5, -290, 4, 16, 3, 34, 47, 134, 11, 158, 5, 176, 13, 255, 317, 325, 473]},
